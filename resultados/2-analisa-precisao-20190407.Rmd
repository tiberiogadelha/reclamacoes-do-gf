...
lm_erro_lexico_compReclamacao_compTitulo_orgao = lm(erro ~ factor(lexico.dummy) + comprimento_reclamacao + comprimento_titulo + orgao.dummy, data=reclamacoes_polarizada)
